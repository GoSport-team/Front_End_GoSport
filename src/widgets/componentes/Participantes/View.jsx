...
export default function ViewJugadores({ isOpen, onClose }) {

    if (!isOpen) return null;

    return (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white p-6 rounded-lg shadow-lg relative w-[50vw]">
                <button
                ...
                <div className="team-name text-gray-900 mb-4 flex items-center space-x-2 ml-2 mt-2">
                    ...
                    <span className="text-md ">Colombia</span>
                </div>
