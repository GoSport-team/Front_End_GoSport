        ...
        <div className="mt-4">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center">
              ...
              />
              <span className="ml-3 font-bold text-xl text-gray-900">{resultado.equipo1.Equipo1.nombreEquipo}</span>
            </div>
            ...
            <div className="flex items-center">
              <span className="mr-3 font-bold text-xl text-gray-900">{resultado.equipo2.Equipo2.nombreEquipo}</span>
              <img
        ...
        <div>
          <div className="mt-4">
            ...
            <ul className="list-none space-y-2">
              ...
              {resultado.equipo1.goles.jugadorGoleador.length >0 ?
               resultado.equipo1.goles.jugadorGoleador.map((jugador,index)=>(
          ...
          <div className="mt-4">
            ...
            <ul className="list-none space-y-2">
              {resultado.equipo1.tarjetasAmarillas.length >0 ?
               resultado.equipo1.tarjetasAmarillas.map((jugador, index)=>(
              <li key={index} className="flex items-center">
          ...
          <div className="mt-4">
            ...
            <ul className="list-none space-y-2">
              {resultado.equipo1.tarjetasRojas >0 ?
              resultado.equipo1.tarjetasRojas.map((jugador, index)=>(
              <li key={index} className="flex items-center">
        ...
        <div>
          <div className="mt-4">
            ...
            <ul className="list-none space-y-2">
              ...
              {resultado.equipo2.goles.jugadorGoleador.length >0 ?
               resultado.equipo2.goles.jugadorGoleador.map((jugador,index)=>(
              <li key={index} className="flex items-center">
                <FaFutbol className="text-green-500 mr-2" /> 
                <span>{jugador.nombres} {jugador.totalGoles} </span>
              </li>
          ...
          <div className="mt-4">
            <p className="font-semibold text-lg text-gray-800">Tarjetas Amarillas:</p>
            <ul className="list-none space-y-2">
              {resultado.equipo2.tarjetasAmarillas.length >0 ?
               resultado.equipo2.tarjetasAmarillas.map((jugador, index)=>(
              <li key={index} className="flex items-center">
                <FaSquareFull className="text-yellow-500 mr-2" /> 
                <span>{jugador.nombres}</span>
              </li>
          ...
          <div className="mt-4">
            <p className="font-semibold text-lg text-gray-800">Tarjetas Rojas:</p>
            <ul className="list-none space-y-2">
              {resultado.equipo2.tarjetasRojas >0 ?
              resultado.equipo2.tarjetasRojas.map((jugador, index)=>(
              <li key={index} className="flex items-center">
                <FaSquareFull className="text-red-600 mr-2" /> 
                <span>{jugador.nombres}</span>
              </li>
