      ...
      <div className="flex flex-col items-center justify-center min-h-screen ">
        {loading ? (
          ...
          <div className="h-screen w-[70vw] ">
            <div className="relative mt-8 h-72 w-full overflow-hidden rounded-xl bg-[url('/img/Seleccion.jpg')] bg-cover bg-center">
                    ...
                    {usuarioId ? (
                      <form className="space-y-4" key={usuarioId._id} onSubmit={handleSubmit(handleBoton)}>
                        ...
                        <div className="flex flex-col lg:flex-row gap-4">
                          ...
                          <button class="w-full select-none rounded-lg bg-[#12aed1cd] py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                            type="submit">
                          Actualizar cambios
                        </button>
                      </form>
