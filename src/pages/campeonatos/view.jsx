...
const CreateCampeonato = () => {
    ...
    return (
        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r font-sans text-lg">
            <section className="w-[50vw] h-[95vh] flex flex-col bg-white px-8 rounded-2xl shadow-2xl border border-gray-200">
                <div className="mt-5">
                    <header className="text-center text-2xl font-bold text-gray-700 mb-1">¡Crea tu Campeonato!</header>
                    <p className="text-center text-gray-500">Completa el formulario a continuación para organizar tu evento</p>
                </div>
                <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
                    <div>
                        <label className="block text-gray-700 font-medium mb-1">Nombre Campeonato</label>
                        <input
                            required
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-200"
                        />
                    </div>

                    <div className="flex space-x-4">
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Disciplina</label>
                            <select
                                required
                        ...
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Tamaño equipo</label>
                            <input
                                required
                    ...
                    <div className="flex space-x-4">
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Fecha de Inicio</label>
                            <input
                                required
                        ...
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Fecha de Fin</label>
                            <input
                                required
                    ...
                    <div className="flex space-x-4">
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Tipo campeonato</label>
                            <select
                                required
                        ...
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Sede</label>
                            <select
                                required
                                value={tipoSede}
                    ...
                    <div className="flex space-x-4">
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Inicio Inscripción</label>
                            <input
                                required
                        ...
                        <div className="w-1/2">
                            <label className="block text-gray-700 font-medium mb-1">Fin de Inscripción</label>
                            <input
                                required
                    ...
                    <button type="submit"
                        className="select-none w-full rounded-lg bg-[#12aed1cd] py-3 px-6 text-center font-sans text-xs font-bold uppercase text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
                        Crear campeonato
                    </button>
                </form>
            </section>
